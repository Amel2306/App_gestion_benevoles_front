...
const VoirDemandes = ({ selectedList, pseudoUser, handleClose }) => {
                            ...
                            <li className={` ${item.archive === 1 ? "bg-indigo-100" : "bg-fuchsia-100"} flex flex-row justify-between p-3 m-4 rounded-xl`} key={index}>
                                ...
                                </div>
                                {
                                    item.accepte === 0 && item.archive === 0 ? (
                                        ...
                                        (
                                            <button className="ml-3 rounded-full bg-indigo-600 px-4 py-2 text-white hover:bg-fuchsia-500 transition-all" onClick={() => handleSubmitDevalide()}>
                                                Supprimer
                                            </button>
                                        )
