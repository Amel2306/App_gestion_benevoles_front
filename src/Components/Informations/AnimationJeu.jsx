...
const AnimationJeu = () => {
    ...
    useEffect(() => {
        axiosInstance.get('post/')
            .then(response => {
                const filteredPosts = response.data.filter(post => post.nom_post === "Animation jeu");
    ...
    return (
        <div className='m-[100px] rounded-lg bg-opacity-85 bg-white p-6 shadow-lg'>
            <h1 className='text-2xl font-bold text-indigo-900'>Informations Animation Jeu</h1>
            <div>
