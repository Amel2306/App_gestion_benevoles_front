...
const ForumAssociation = () => {
    ...
    useEffect(() => {
        ...
        axiosInstance.get('post/')
            .then(response => {
                const filteredPosts = response.data.filter(post => post.nom_post === "Forum association");
    ...
    return (
        <div className='m-[100px] rounded-lg bg-opacity-85 bg-white p-6 shadow-lg'>
            <h1 className='text-2xl font-bold text-indigo-900'>Informations Forum Association</h1>
            <div>
